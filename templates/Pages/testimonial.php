...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech || Testimonial')) ?>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“Their feedback fuel our passion for continuous improvement and The innovation. We take immense pride <br> in the relationships we’ve built and <br> the trust we’ve earned through.”</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“We believe that the true measure <br> of success lies in the satisfaction & <br> trust of our clients. Their stories of growth and transformation inspire <br> us to deliver excellence every step.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“From streamlining operations the delivering innovative solutions, we pride in the positive impact we’ve <br> had on businesses of all sizes. Hear directly from satisfied customers.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“From startups to large enterprises, we’ve had the privilege supporting businesses across industries. Read what our partners have say about <br> the quality, reliability, and impact.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“Client satisfaction our top priority, <br> & nothing speaks louder than the words of those helped. Whether <br> it's through managed IT services, cybersecurity solutions, or cloud.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“Their trust and satisfaction inspire <br> us to constantly raise bar. Explore <br>the stories and testimonials from businesses that have benefited <br> from our reliable services.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">“The true value of our services lies <br> in the success stories of our clients. Each partnership our dedication to understanding needs & delivering tailored solution whether through.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="vl-testimonial-box vl-testimonial-box-inner vl-gray-bg-4 p-relative br-8 mb-30">
                            ...
                            <div class="vl-testimonial-box-content pt-20 pb-30">
                                <p class="vl-text-cmn-blck vl-medium vl-fs-20 vl-lineheight-32">"Each testimonial reflects the trust <br> our clients place in us the success <br> we achieve together. With a focus <br> on innovation, proactive support, <br> and customer satisfaction.”</p>
                            </div>
                            <div class="vl-testimonial-box-auth p-relative">
                                <div class="vl-testimonial-box-auth-img">
