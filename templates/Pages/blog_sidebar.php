...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech || Blog Sidebar')) ?>
                        ...
                        <div class="vl-sidebar-widget">
                            ...
                            <div class="vl-sidebar-widget-search mb-30 vl-gray-bg-4 br-16">
                                ...
                                <div class="vl-sidebar-rec-post">
                                    <ul>
                                        <li><a href="blog-single">Technology Solution <span><i class="fa-regular fa-angle-right"></i></span></a></li>
                                        <li><a href="blog-single">Website & Mobile App <span><i class="fa-regular fa-angle-right"></i></span></a></li>
                                        <li><a href="blog-single">Tracking Security <span><i class="fa-regular fa-angle-right"></i></span></a></li>
                                        <li><a href="blog-single">Mobile App Design <span><i class="fa-regular fa-angle-right"></i></span></a></li>
                                        <li><a href="blog-single">IT Management Service <span><i class="fa-regular fa-angle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
