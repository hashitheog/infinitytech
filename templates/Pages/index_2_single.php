...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech 2 || Single' , 'logo2' => true)) ?>
...
<body>
    ...
    <?= $this->element('loader', array('loader2' => true)) ?>
    ...
    <main>
                    ...
                    <div class="col-xl-6 mb-30">
                        <div class="vl-hero-content p-relative z-index-1">
                            <div class="vl-section-title-wrapper">
                                ...
                                <p class="vl-section-description section-description3  pt-16 pb-28">Empower your business with cutting technology solutions <br> tailored to meet your unique needs from cloud computing.</p>
                            </div>

                            <div class="vl-hero-btn">
                                <a href="contact" class="them-btn2 fix mr-16">Explore Solutions <span><i class="fa-regular fa-angle-right"></i></span></a>
                                <a href="contact" class="theme-sec-btn2">Contact Us<span><i class="fa-regular fa-angle-right"></i></span></a>
        ...
        <section id="about" class="vl-about-area pt-100 pb-70">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-content aos-init aos-animate" data-aos="fade-left" data-aos-duration="900">
                            <div class="vl-section-title-wrapper">
                                ...
                                <p class="vl-section-description-2 pb-32">With a passion for solving complex challenges, we specialize in <br> delivering tailored IT solutions that empower businesses thrive.</p>
                            </div>
                            ...
                            <div class="vl-about-btn">
                                <a href="about" class="them-btn2">See my experience<span><i class="fa-regular fa-angle-right"></i></span></a>
        ...
        <section id="service" class="vl-service-area vl-gray-bg pt-100 pb-70">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <div class="vl-service-content vl-service-content-2">
                            ...
                            <p class="pt-16 pb-24">Keep your business running with reliable and optimized IT infrastructure <br> We provide end-to-end infrastructure management, from network design.</p>
                            <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-angle-right"></i></span></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1200">
                        <div class="vl-service-content vl-service-content-2">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single">Software Development</a></h2>
                    ...
                    <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1400">
                        <div class="vl-service-content vl-service-content-2">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single">Cybersecurity Services</a></h2>
                            <p class="pt-16 pb-24">Protect your business from evolving cyber threats <br> with our comprehensive cybersecurity solutions.</p>
                            <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-angle-right"></i></span></a>
                        </div>
                    </div>
                    <!-- single service box end-->
                    ...
                    <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1600">
                        <div class="vl-service-content vl-service-content-2">
                            ...
                            <p class="pt-16 pb-24">Navigate the complexities of technology with expert guidance from our IT <br> consultants. We help businesses strategize & implement the right solution.</p>
                            <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-angle-right"></i></span></a>
                        </div>
                    </div>
                    <!-- single service box end-->
        ...
        <section id="case" class="vl-gallery3 p-relative z-index-1 pt-100 pb-100">
            <div class="container">
                ...
                <div id="gallery2" class="owl-carousel owl-theme">
                    ...
                    <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
                        ...
                        <div class="vl-gallery-poligon poligon2">
                            ...
                            <a href="case-studies-single"><span class="arow2"><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
        ...
        <section id="testimonial" class="vl-testimonial-section2 vl-theme-bg-2 pt-100 pb-100">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
        ...
        <!--================= Team section start =================-->
        <section id="team" class="vl-teamm p-relative z-index-1 pt-100 pb-100">
                    ...
                    <div id="teamm2" class="owl-carousel owl-theme">
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team">Kendra Cremin</a></h4>
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team">Dennis Jacobson</a></h4>
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team">Patricia Wilkinson</a></h4>
                                <span>Network Engineer</span>
                            </div>
                        </div>
                        <!-- single team end -->
        ...
        <section id="contact" class="vl-contact vl-gray-bg p-relative z-index-1 pt-100 pb-70">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="vl-contact-box br-4 vl-white-bg mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-contact-box-content">
                                ...
                                <p class="off-w pt-20 pb-32 m-0">Have questions or need assistance? We're here to help! Whether <br> you're exploring solutions, looking for a consultation, or need.</p>
                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="vl-blog-content-2 mb-30 aos-init aos-animate" data-aos="fade-right data-aos-duration=" 900">
                            <div class="vl-section-title-wrapper">
                                ...
                                <p class="vl-section-description-2 pb-32">Our expert team works closely with you to understand <br> your unique challenges and design strategies that<br> propel your business forward into the future.</p>
                            </div>
                            <div class="vl-blog-btn">
                                <a href="blog" class="them-btn2">read more blog <span><i class="fa-regular fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="vl-single-blog ml-60">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="blog-single"><img class="br-8 w-100" src="/img/blog/vl-blog-1.1.png" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a href="blog-single">Your Trusted Partner in <br> Technology Transformation</a></h3>
                                            <p class="vl-single-blog-desc pt-10 pb-24">As your trusted partner, we take <br> the time understand your business objectives and challenges.</p>
                            ...
                            <div class="vl-single-blog-item vl-blg2 vl-gray-bg mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1300">
                                <div class="row align-items-center">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="blog-single"><img class="br-8 w-100" src="/img/blog/vl-blog-1.2.png" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a href="blog-single">Driving Success Through <br> Innovation and Collaboration</a></h3>
                                            <p class="vl-single-blog-desc pt-10 pb-24">We foster a culture of teamwork & <br> creative problem-solving to deliver exceptional results for our clients.</p>
                                            <a href="blog-single" class="vl-readmore">Read More <span class="rot-minus"><i class="fa-regular fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="vl-cta-wrapper mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                                ...
                                <div class="vl-cta-btn">
                                    <a href="blog" class="them-btn2">Start Your Journey<span><i class="fa-regular fa-angle-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-footer-widget-1">
                            <div class="vl-footer-logo">
                                <a href="index"><img src="/img/logo/vl-logo-2.2.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-footer-widget-4">
                            ...
                            <p class="black">Subscribe us & receive our <br> latest news & articles</p>

                            <div class="vl-footer-newsletter vl-footer-newsletter-2">
                                <form action="#">
                                    <input type="email" name="email" id="email" placeholder="Email Address..">
                                    <div class="vl-footer-newsletter-btn-2 mt-16">
                                        <button class="w-100 them-btn2 btn-dot">Subscribe<span><i class="fa-regular fa-angle-right"></i></span>
                                        </button>
                                    </div>
                                </form>
                            </div>
    ...
    <?= $this->element('progress_circle', array('divClass' => "progress-wrap2")) ?>
