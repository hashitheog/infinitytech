...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech 3 || Single' , 'logo3' => true)) ?>
...
<body>
    ...
    <main>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs vl-about-imgs-3 p-relative z-index-1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            ...
                            <div class="vl-about-content br-8">
                                ...
                                <p>With 12+ years of experience <br>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-content vl-about-content-3 aos-init aos-animate" data-aos="fade-left" data-aos-duration="900">
                            <div class="vl-section-title-wrapper">
                                ...
                                <p class="vl-section-description vl-section-description-3 pb-32">With a passion for solving complex challenges, we specialize in <br> delivering tailored IT solutions that empower businesses thrive.</p>
                            </div>
        ...
        <section id="service" class="vl-service-area vl-gray-bg-2 pt-100 pb-70">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single">IT Consulting Services</a></h2>
                            <p class="pt-16 pb-24">Navigate the complexities technology with expert guidance <br> from our IT consultants. We help businesses strategize.</p>
                            <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single">IT Infrastructure Management</a></h2>
                            <p class="pt-16 pb-24">Keep your business running smoothly with reliable optimized <br> IT infrastructure we provide end infrastructure management.</p>
                            <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                    <!-- single service box end-->
                        ...
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single">Cybersecurity Services</a></h2>
                                    <p class="pt-16 pb-24">Protect your business from evolving cyber threats with our comprehensive cybersecurity solutions. From threat detection <br> and response to data encryption and compliance management, we safeguard your digital  24/7.</p>
                                    <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1400">
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single">Cloud Solutions</a></h2>
                                    <p class="pt-16 pb-24">Leverage the power the cloud to streamline your <br> operations boost scalability. Our cloud solutions <br>offer secure and flexible environments tailored.</p>
                                    <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1500">
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single">Software Development</a></h2>
                                    <p class="pt-16 pb-24">Transform your ideas into reality with our custom <br> software development services. Whether you <br> need mobile apps, web platforms, or enterprise.</p>
                                    <a href="service-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
        ...
        <section id="case" class="vl-gallery2 p-relative z-index-1 pt-100 pb-100">
                ...
                <div class="row">
                    <div id="gallery3" class="owl-carousel owl-theme">
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single">Efficiency Managed IT Services</a></h3>
                                    <p>Our solutions ensure availability,<br> minimal downtime, & improved.</p>
                                    <a href="case-studies-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single">Fortifying Cybersecurity</a></h3>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single">Building Resilient Networks </a></h3>
        ...
        <section id="testimonial" class="vl-testimonial vl-testimonial-bg pt-100 pb-100" style="background-image: url(/img/testimonial/vl-testimonial-bg-3.1.jpg);">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-testimonial-active-4">
                                ...
                                <div class="vl-testimonial-box vl-testimonial-box-3 p-relative br-8">
                                    ...
                                    <div class="vl-testimonial-box-content text-center pt-20 pb-30">
                                        <p>“From seamless cloud migrations to enhanced cybersecurity, <br> our work has helped businesses grow, adapt, and succeed in an ever-evolving digital landscape. But don't just take our word for hear directly those who have experienced the difference.”</p>
                                    </div>
        ...
        <section id="work" class="vl-success p-relative z-index-1 pt-100 pb-70">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single">Discovery & Planning</a></h3>
                                <p>We begin by understanding your <br> business needs, challenges, & <br>goals through in-depth.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single">Design & Development</a></h3>
                                <p>With a clear plan in place, our <br> experts move into the design and <br> development phase. </p>
                            </div>
                        </div>
                    </div>
                    <!-- single success icbox end -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single">Continuous Improvement</a></h3>
                                <p>In a fast-changing digital world,<br> staying ahead is essential. That’s <br>why we continuously monitor.</p>
                            </div>
                        </div>
                    </div>
                    <!-- single success icbox end -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single">Launch & Support</a></h3>
                                <p>Once everything is in place, we <br> the solution with comprehensive <br>support but our work doesn’t.</p>
                            </div>
                        </div>
                    </div>
                    <!-- single success icbox end -->
        ...
        <!--================= Faq section start =================-->
        <section id="faq" class="vl-faq vl-gray-bg-2 pt-100 pb-70">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-accordion-item mb-20">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>The implementation timeline varies depending on the complexity and scope of the <br> project. We prioritize efficiency compromising quality & keep you informed.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single"><img class="br-8 w-100" src="/img/blog/vl-blog-3.1.png" alt=""></a>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single">Revolutionize Your Operations <br> with Our Expertise</a></h3>
                                <a href="blog-single" class="vl-readmore more3">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single"><img class="br-8 w-100" src="/img/blog/vl-blog-3.2.png" alt=""></a>
                                <div class="vl-single-blog-tag">
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single">Empowering Your Business with <br> Cutting-Edge Insights</a></h3>
                                <a href="blog-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1300">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single"><img class="br-8 w-100" src="/img/blog/vl-blog-3.3.png" alt=""></a>
                                <div class="vl-single-blog-tag">
                                    <a href="#">It Service</a>
                                </div>
                            </div>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single">Transform Your Business with <br> Innovative Solutions</a></h3>
                                <a href="blog-single" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-30">
                            <div class="vl-hero-btn-3 fl-right">
                                <a href="contact" class="vl-btn-3">CONTACT US<span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-footer-widget-1">
                            <div class="vl-footer-logo">
                                <a href="index"><img src="/img/logo/vl-logo-3.2.png" alt=""></a>
                            </div>
                            <div class="vl-footer-content vl-footer-content-3">
                                <p class="pt-16 pb-32">We foster a culture of teamwork & <br> creative problem-solving to deliver <br> exceptional results for our clients.</p>
                            </div>
    ...
    <?= $this->element('progress_circle', array('divClass' => "progress-wrap3")) ?>
