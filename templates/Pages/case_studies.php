...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech || Case Studies')) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">Custom Software Development</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">IoT Integration Solutions</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">Process Automation Project</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">Digital Transformation Strategy</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">Managed IT Service Solutions</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-testimonial-2 br-4 fix p-relative mb-30 z-index-1">
                            ...
                            <div class="vl-gallery-testimonial-2-con">
                                <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single">Sustainable IT Infrastructure</a></h3>
                            </div>
                            <div class="vl-gallery-poligon">
                                <h3><a href="case-studies-single">Read More</a></h3>
                                <span class="blu-bg"><i class="fa-regular fa-arrow-right"></i></span>
