...
<head>
    <?= $this->element('title_meta', array('title' => 'O-Tech || Service Left')) ?>
                        ...
                        <div class="vl-service-details ml-80">
                            ...
                            <div class="vl-service-details-content">
                                <div class="vl-service-content-block-1 mb-30">
                                    ...
                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">Keep your business running smoothly with reliable and optimized IT infrastructure. We <br> provide end-to-end infrastructure management network design & setup to maintenance <br> and monitoring. Our solutions ensure high availability, minimal downtime.</p>

                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">Our managed IT services offer businesses the convenience of outsourcing technology <br>needs while maintaining full control and visibility. From 24/7 system monitoring.</p>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="vl-service-details-content mb-30">
                                            ...
                                            <div class="vl-service-details-content-check">
                                                <ul>
                                                    <li> <span><i class="fa-regular fa-check"></i></span> Technology Consultancy</li>
                                                    <li> <span><i class="fa-regular fa-check"></i></span> Maintenance And Support </li>
                                                    <li> <span><i class="fa-regular fa-check"></i></span> We Provide best services</li>
                                                    <li> <span><i class="fa-regular fa-check"></i></span> Requirements Gathering</li>
                                                    <li> <span><i class="fa-regular fa-check"></i></span> Business Growth</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="vl-service-content-block-2 mb-30">
                                    ...
                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">Our range of IT services is designed to meet the diverse needs of businesses, whether <br> small startups or large enterprises. From managed IT support and cloud computing to <br> cybersecurity & software development, we offer end-to-end solutions that enhance.</p>

                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">We offer end-to-end solutions that enhance efficiency and drive innovation. Our experts <br> collaborate with you to identify pain points implement tailored strategies that optimize.</p>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="vl-about-icon-box-4 vl-service-box vl-gray-bg-4 d-flex br-8 mb-30">
                                            ...
                                            <div class="vl-service-box-content">
                                                ...
                                                <p class="vl-text-para m-0">Before going live, we rigorously <br> test every component to ensure</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="vl-about-icon-box-4 vl-service-box vl-gray-bg-4 d-flex br-8 mb-30">
                                            ...
                                            <div class="vl-service-box-content">
                                                ...
                                                <p class="vl-text-para m-0">Once everything is in place, we <br> launch solution comprehensive</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="vl-service-content-block-3">
                                    ...
                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">We specialize in delivering customized IT solutions that drive business transformation. <br> Whether you’re looking to streamline operations with automation, enhance customer <br> engagement through digital platforms, or safeguard your data with advanced.</p>

                                    <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">Cybersecurity measures, our services are built to provide a competitive advantage. With <br> a commitment to excellence, we help you stay ahead in today’s fast-evolving digital.</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4  p-relative z-index-1 fix br-8">
                            ...
                            <div class="vl-service-icon-box-4-content4">
                                ...
                                <p class="pb-24">Leverage the power cloud to enhance <br> scalability, flexibility, and performance <br>Our cloud computing solutions secure.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4 p-relative z-index-1 fix br-8">
                            ...
                            <div class="vl-service-icon-box-4-content4">
                                ...
                                <p class="pb-24">Optimize your business operations with <br> reliable IT infrastructure management <br> From network setup to hardware.</p>
                                <a href="#" class="readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4 p-relative z-index-1 fix br-8">
                            ...
                            <div class="vl-service-icon-box-4-content4">
                                ...
                                <p class="pb-24">In today’s digital world, protecting your <br> data is more critical than ever. Our Best <br> comprehensive cybersecurity services.</p>
                                <a href="#" class="readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
