                                            ...
                                            <div class="row gx-4 row-cols-1 row-cols-lg-4">
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn vl-home-btn4">
                                                            <a href="index" target="_blank" class="vl-btn-sec">
                                                            ...
                                                            <a href="index-1-single" target="_blank" class="vl-btn-sec mt-20">
                                                                <span class="vl-btn-wrap">
                                                ...
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn vl-home-btn4">
                                                            <a href="index2" target="_blank" class="vl-btn-sec">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Multi Page </span>
                                                                    <span class="vl-btn-y-2"> Multi Page </span>
                                                                </span>
                                                            ...
                                                            <a href="index-2-single" target="_blank" class="vl-btn-sec mt-20">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Single Page </span>
                                                                    <span class="vl-btn-y-2"> Single Page </span>
                                                                </span>
                                                ...
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn vl-home-btn4">
                                                            <a href="index3" target="_blank" class="vl-btn-sec">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Multi Page </span>
                                                                    <span class="vl-btn-y-2"> Multi Page </span>
                                                                </span>
                                                            ...
                                                            <a href="index-3-single" target="_blank" class="vl-btn-sec mt-20">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Single Page </span>
                                                                    <span class="vl-btn-y-2"> Single Page </span>
                                                                </span>
                                                ...
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn vl-home-btn4">
                                                            <a href="index-4" target="_blank" class="vl-btn-sec">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Multi Page </span>
                                                                    <span class="vl-btn-y-2"> Multi Page </span>
                                                                </span>
                                                            ...
                                                            <a href="index-4-single" target="_blank" class="vl-btn-sec mt-20">
                                                                <span class="vl-btn-wrap">
                                                                    <span class="vl-btn-y-1"> Single Page </span>
                                                                    <span class="vl-btn-y-2"> Single Page </span>
                                                                </span>
    ...
    <div class="vl-offcanvas-wrapper">
        <div class="vl-offcanvas-header d-flex justify-content-between align-items-center mb-50">
            <div class="vl-offcanvas-logo">
                <a href="index"><img src="/img/logo/vl-off-logo-4.1.png" alt=""></a>
            </div>
        ...
        <div class="vl-offcanvas-btnm text-center mb-30">
            <a href="contact" class="vl-btn-sec w-100">
                <span class="vl-btn-wrap">
                    <span class="vl-btn-y-1"> get started </span>
                    <span class="vl-btn-y-2"> get started </span>
                </span>
