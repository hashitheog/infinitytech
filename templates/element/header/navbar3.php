            ...
            <div class="row align-items-center">
                    ...
                    <div class="vl-main-menu text-center">
                        <nav class="vl-mobile-menu-active">
                            <ul>
                                                ...
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="index" target="_blank" class="thme-btn3">Multi Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                            <a href="index-1-single" target="_blank" class="thme-btn3  mt-20">Single Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="index2" target="_blank" class="thme-btn3">Multi Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                            <a href="index-2-single" target="_blank" class="thme-btn3  mt-20">Single Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="index3" target="_blank" class="thme-btn3">Multi Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                            <a href="index-3-single" target="_blank" class="thme-btn3  mt-20">Single Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="index-4" target="_blank" class="thme-btn3">Multi Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                            <a href="index-4-single" target="_blank" class="thme-btn3  mt-20">Single Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="has-dropdown"><a href="#">Services <span><i class="fa-regular fa-angle-down"></i></span></a>
                                ...
                                <li class="has-dropdown"><a href="#">Case Studies <span><i class="fa-regular fa-angle-down"></i></span></a>
                                    <ul class="sub-menu sub-menu-3">
                                        <li><a href="case-studies">Case Studies</a></li>
                                        <li><a href="case-studies-left">Case Studies Left</a></li>
                                        <li><a href="case-studies-right">Case Studies Right</a></li>
                                        <li><a href="case-studies-single">Case Studies Single</a></li>
                                    </ul>
                                </li>

                                <li class="has-dropdown"><a href="#">Blog <span><i class="fa-regular fa-angle-down"></i></span></a>
                                    <ul class="sub-menu sub-menu-3">
                                        <li><a href="blog">Blog</a></li>
                                        <li><a href="blog-left">Blog Left</a></li>
                                        <li><a href="blog-right">Blog Right</a></li>
                                        <li><a href="blog-single">Blog Single</a></li>
                                        <li><a href="blog-sidebar">Blog Standred</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="vl-hero-btn-3 d-none d-lg-block text-lg-end fl-right">
                        <a href="" class="vl-btn-3">GET STARTED<span><i class="fa-regular fa-arrow-right"></i></span></a>
                    </div>
    ...
    <div class="vl-offcanvas-wrapper">
        ...
        <div class="vl-offcanvas-btnm text-center mb-30">
            <div class="vl-about-authbtn">
                <a href="#" class="thme-btn3 w-100">Get Started <span><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
        </div>
