            ...
            <div class="row align-items-center">
                                            ...
                                            <div class="row gx-4 row-cols-1 row-cols-lg-4">
                                                    ...
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <div class="vl-hero-btn2">
                                                                <a href="index" target="_blank" class="them-btn2">Multi Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                            <div class="vl-hero-btn2 mt-20">
                                                                <a href="index-1-single" target="_blank" class="them-btn2">Single Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <div class="vl-hero-btn2">
                                                                <a href="index2" target="_blank" class="them-btn2">Multi Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                            <div class="vl-hero-btn2 mt-20">
                                                                <a href="index-2-single" target="_blank" class="them-btn2">Single Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <div class="vl-hero-btn2">
                                                                <a href="index3" target="_blank" class="them-btn2">Multi Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                            <div class="vl-hero-btn2 mt-20">
                                                                <a href="index-3-single" target="_blank" class="them-btn2">Single Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-25">
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <div class="vl-hero-btn2">
                                                                <a href="index-4" target="_blank" class="them-btn2">Multi Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                            <div class="vl-hero-btn2 mt-20">
                                                                <a href="index-4-single" target="_blank" class="them-btn2">Single Page<span><i class="fa-regular fa-angle-right"></i></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="vl-hero-btn2 d-none d-lg-block text-lg-end">
                        <a href="contact" class="them-btn2">get started <span><i class="fa-regular fa-angle-right"></i></span></a>
                    </div>
...
<div class="vl-offcanvas">
    <div class="vl-offcanvas-wrapper">
        ...
        <div class="vl-offcanvas-btnm text-center mb-30">
            <a href="#" class="them-btn2 w-100">get started <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
